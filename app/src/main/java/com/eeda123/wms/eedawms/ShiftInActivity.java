...
public class ShiftInActivity extends AppCompatActivity {
    ...
    public void confirmOrder(Context context) {
        DbHelper database_helper = new DbHelper(ShiftInActivity.this);
        ...
        db.execSQL("insert into gate_in(qr_code, part_no, quantity, shelves,creator,create_time,move_flag)" +
